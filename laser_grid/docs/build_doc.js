...
body.push(P("벽 + 바닥 + 동바리가 한 프레임에 들어오는 합성 씬에서 두 세그멘테이션 백엔드 모두 전 항목 통과하였다. 장비를 34° 하향으로 잡아 벽과 바닥을 한 장에 담았다. V선 위 격자점은 4,826개(벽 3,503 · 바닥 1,022 · 동바리 301)다."));
body.push(Gap(60));
body.push(Tbl(
  ["부재", "검측 항목", "정답", "gt 백엔드", "geom 백엔드"],
  [
    ["벽", "수직도", "0.50 °", "오차 0.0150 °", "오차 0.0274 °"],
    ["바닥", "수평도", "0.30 °", "오차 0.0176 °", "오차 0.0244 °"],
    ["동바리", "축 수직도", "1.20 °", "오차 0.1431 °", "오차 0.2584 °"],
    ["벽", "요철 깊이", "융기 6.0 mm", "5.57 mm", "5.50 mm"],
    ["벽", "직선자 처짐", "—", "4.76 mm (하한)", "4.06 mm (하한)"],
  ],
