...
PRODUCT_LEXICON: Dict[str, str] = {
    ...
    # 뷰티/스킨케어 (추가)
    "cleansing oil": "클렌징오일", "cleansing balm": "클렌징밤", "toner": "토너",
    "essence": "에센스", "ampoule": "앰플", "eye cream": "아이크림",
    "spf": "선크림", "niacinamide": "나이아신아마이드 세럼", "salicylic acid": "살리실산 토너",
    "centella": "시카크림", "cica": "시카크림", "snail mucin": "달팽이크림",
    "body lotion": "바디로션", "hand cream": "핸드크림", "foot mask": "발각질제거",
    "lip mask": "립마스크", "gua sha": "괄사", "jade roller": "괄사 마사지롤러",
    "led mask": "LED 마스크", "derma roller": "더마롤러", "pore strip": "코팩",
    "hair oil": "헤어오일", "shampoo": "샴푸", "scalp serum": "두피 에센스",
    "hair mask": "헤어팩", "heatless curls": "헤어롤", "silk pillowcase": "실크 베개커버",
    "nail file": "네일파일", "makeup brush": "메이크업 브러쉬", "beauty blender": "메이크업 스펀지",
    # 헬스/영양 (추가)
    "biotin": "비오틴", "ashwagandha": "아슈와간다", "zinc": "아연",
    "vitamin d": "비타민D", "iron supplement": "철분제", "melatonin": "멜라토닌",
    "greens powder": "그린스 파우더", "fiber supplement": "식이섬유 보충제",
    "lutein": "루테인", "milk thistle": "밀크씨슬", "psyllium husk": "차전자피",
    "heating pad": "찜질팩", "posture corrector": "자세교정밴드",
    "blue light glasses": "블루라이트 차단안경", "acupressure mat": "지압매트",
    "pilates ring": "필라테스링", "ankle weights": "발목모래주머니",
    "body scale": "체중계", "blood pressure monitor": "혈압계", "nasal spray": "코세척기",
    # 수면/집중/작업
